...
public class Permission extends AbstractEditable {
	...
	/*Mobile menutext permissions*/
	public static final String PERM_ADD_MOBILEMENUTEXT = "Perm_Add_MobileMenuText";
	public static final String PERM_VIEW_MOBILEMENUTEXT ="Perm_View_MobileMenuText";
	public static final String PERM_DELETE_MOBILEMENUTEXT = "Perm_Delete_MobileMenuText";
	public static final String PERM_EDIT_MOBILEMENUTEXT = "Perm_Edit_MobileMenuText";
	public static final String PERM_TRANSLATE_MOBILE_MENU_TEXT = "Perm_Translate_Mobile_Menu_Text";
