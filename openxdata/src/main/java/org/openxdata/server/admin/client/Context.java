...
public class Context implements OpenXDataObserver {
	...
	public static FormServiceAsync getFormServiceAsync() {
        ...
        public static SpecificationServiceAsync getSpecificationService(){
                return SpecificationServiceAsync.Util.getInstance();
        }

        public static SpecStudyMapServiceAsync getMapServiceAsync(){
                return SpecStudyMapServiceAsync.Util.getInstance();
        }
}
