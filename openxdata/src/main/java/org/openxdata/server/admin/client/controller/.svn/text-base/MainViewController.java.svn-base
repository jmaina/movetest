...
public class MainViewController {
	...
	/**
	 * An instance of
	 * {@link org.openxdata.server.admin.client.controller.UserViewController}
	 * 
	 * This will handle all movement of data for the views in relation to
	 * loading, saving and movement of Users related data.
	 */
	private UserViewController userViewController;
	
	/**
	 * An instance of
	 * {@link org.openxdata.server.admin.client.controller.TasksViewController}
	 * 
	 * This will handle all movement of data for the views in relation to
	 * loading, saving and movement of Tasks related data.
	 */
	private TasksViewController tasksViewController;
	
	/**
	 * An instance of
	 * {@link org.openxdata.server.admin.client.controller.RolesViewController}
	 * 
	 * This will handle all movement of data for the views in relation to
	 * loading, saving and movement of Permissions related data.
	 */
	private RolesViewController rolesViewController;
	
	/**
	 * An instance of
	 * {@link org.openxdata.server.admin.client.controller.UtilityViewController}
	 * 
	 * This will handle all movement of data for the views in relation to
	 * loading, saving and movement of Utilities related data. Utilities include
	 * locales, mobile menu text
	 */
	 ...
	 * @param usersTreeView
	 *            Users tree view that will be loaded on the UI
	 * @param rolesTreeView
	 *            Settings tree view that will be loaded on the UI
	 * @param tasksTreeView
	 *            Tasks tree view that will be loaded on the UI
	 ...
	 * @param userView
	 *            Studies view that will be loaded on the UI
	 * @param roleView
	 *            Role view that will be loaded on the UI
	 * @param reportView
	 *            View to display Report Properties
	 */
	public MainViewController(OpenXDataBaseTreeView studiesTreeView,
	        OpenXDataBaseTreeView usersTreeView,
	        OpenXDataBaseTreeView rolesTreeView,
	        OpenXDataBaseTreeView tasksTreeView,
	        OpenXDataBaseTreeView settingsTreeView,
	        OpenXDataBaseTreeView reportsTreeView, OpenXDataBaseView studyView,
	        OpenXDataBaseView userView, OpenXDataBaseView roleView,
	        OpenXDataBaseView reportView) {
		
		setupUtilityViewController();
		...
		setupStudiesViewController(studiesTreeView, studyView, userView,
		        reportView);
	}
	 ...
	 * 
	 */
	private void setupUtilityViewController() {
		
		utilityViewController = new UtilityViewController();
		
		// Registering Observers
		utilityViewController.addObserver(Context.getContextInstance());
	}
	 ...
	 * 
	 * @param rolesTreeView
	 *            instance of {@link TasksTreeView} that was created by the
	 *            factory.
	 */
	 ...
	 *            factory.
	 */
	private void setupSettingsViewController(
	        OpenXDataBaseTreeView settingsTreeView) {
	 ...
	 * 
	 * @param rolesTreeView
	 *            instance of {@link RolesTreeView} that was created by the
	 *            factory.
	 * @param roleView
	 *            instance of {@link RoleView} that was created by the factory.
	 */
	private void setupRolesViewController(OpenXDataBaseTreeView rolesTreeView,
	        OpenXDataBaseView roleView) {
		
		rolesViewController = new RolesViewController(rolesTreeView, roleView);
		
		// Registering Observers
		rolesViewController.addObserver(Context.getContextInstance());
	 ...
	 *            factory.
	 * @param userView
	 *            instance of {@link UserView} that was created by the factory.
	 */
	private void setupReportsViewController(
	        OpenXDataBaseTreeView reportsTreeView,
	        OpenXDataBaseView reportView, OpenXDataBaseView userView) {
	...
	private void setupStudiesViewController(
	        OpenXDataBaseTreeView studiesTreeView, OpenXDataBaseView studyView,
	        OpenXDataBaseView userView, OpenXDataBaseView reportView) {
	 ...
	 * 
	 * @param usersTreeView
	 *            instance of {@link UsersTreeView} that was created by the
	 *            factory.
	 * 
	 */
	private void setupUserViewController(OpenXDataBaseTreeView usersTreeView,
	        OpenXDataBaseView studyView) {
		
		userViewController = new UserViewController(
		        (UsersTreeView) usersTreeView);
		
		// Registering observers
		userViewController.addObserver(Context.getContextInstance());
	...
	/**
	 * Returns an instance of the User Controller for the application. Should
	...
	/**
	 * Returns an instance of the Tasks Controller for the application. Should
	 * never be set manually but left to the Main View Controller to build one
	 * in order to have a single one for the whole application
	 * 
	...
	/**
	 * Returns an instance of the Utility Controller for the application. Should
	 * never be set manually but left to the Main View Controller to build one
	 * in order to have a single one for the whole application
	 * 
