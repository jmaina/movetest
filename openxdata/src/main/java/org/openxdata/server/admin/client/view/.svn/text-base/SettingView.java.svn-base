...
public class SettingView extends OpenXDataBaseView {
	 ...
	 */
	public SettingView(OpenXDataViewFactory openXDataViewFactory) {
	...
	private void updateName() {
		if (setting != null) {
			...
			eventBus.fireEvent(new ItemChangedEvent(setting));
		} else {
			settingGroup.setName(txtName.getText());
                        eventBus.fireEvent(new ItemChangedEvent(settingGroup));
		}
	}
	...
	private void bindHandlers() {
		ItemSelectedEvent.HandlerAdaptor handler = new ItemSelectedEvent.HandlerAdaptor() {
			...
			public void onSettingSelected(Composite sender, Setting setting) {
				onItemSelected(sender, setting);
			}
			
			@Override
			public void onSettingGroupSelected(Composite sender,
			        SettingGroup group) {
				onItemSelected(sender, group);
			}
		};
