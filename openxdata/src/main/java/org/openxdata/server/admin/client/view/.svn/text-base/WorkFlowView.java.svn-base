...
import org.openxdata.modules.workflows.model.shared.SpecStudyMapDTO;
...
public class WorkFlowView extends OpenXDataBaseView implements
        ...
        public WorkFlowView( OpenXDataViewFactory openXDataViewFactory) {
                super(openXDataViewFactory);
                setUp();
                specStdSrv = Context.getMapServiceAsync();
                specSrv = Context.getSpecificationService();
                initHandlers();
                bindToToolBarEvents();
        ...
        private void initHandlers() {
                GWT.log("Initialising handler for WFView");
