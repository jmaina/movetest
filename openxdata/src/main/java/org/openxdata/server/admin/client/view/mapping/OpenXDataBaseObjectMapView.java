 ...
 *
 */
public abstract class OpenXDataBaseObjectMapView extends Composite {
	...
	protected Object treeviewSelectedItem;	
	 ...
	 */
	protected OpenXDataBaseObjectMapView(EventBus eventBus){
	...
	/**
	 * Saves the <tt>Mapped Objects</tt> on the current <tt>Widget.</tt> 
	 */
	...
	/**
	 * Initializes the selected <code>Object's properties</code>
	 * 
	 ...
	 * <p>
	 * After this operation, the selected Object will be the one selected on the <tt>Tree View.</tt>
	 * </p>
	 * 
	...
	public void onItemSelected(Composite sender, Object item) {
		...
		// where a Tree view selection event [onItemSelected] would fire twice returning the selected item twice.
		if(treeviewSelectedItem == item){
			return;
		}
		else{
        ...
        private void initHandlers() {
                ItemSelectedEvent.Handler handler = new ItemSelectedEvent.HandlerAdaptor() {

                        @Override
                        public void onUserSelected(Composite sender, User user) {
                                onItemSelected(sender, user);
                        }
