...
public class SettingsTreeView extends OpenXDataBaseTreeView implements
	...
	public void onSave() {
        ...
        private void initHandlers() {
                ItemChangedEvent.Handler itemChanegeHandler = new ItemChangedEvent.HandlerAdaptor() {

                        @Override
                        public void onSettingChanged(Composite sender, Setting setting) {
                                changeEditableProperties(setting);
                        }

                        @Override
                        public void onSettingGroupChanged(Composite sender, SettingGroup group) {
                                changeEditableProperties(group);
                        }
                };

                eventBus.addHandler(ItemChangedEvent.TYPE, itemChanegeHandler);
        }
}