...
public interface UtilityService extends RemoteService {
	 ...
	 */
	List<MobileMenuText> getMobileMenuText(String locale) throws OpenXDataSecurityException;
	 ...
	 * @throws OpenXDataSecurityException For any <tt>security related</tt> that occurs on the <tt>service layer.</tt>  
	 */
	void saveMobileMenuText(List<MobileMenuText> mobileMenuText) throws OpenXDataSecurityException;
