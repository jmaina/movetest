...
public class MoveitWIRUploadHandler implements RequestHandler
{
        ...
        public void handleRequest(User user, InputStream is, OutputStream os) throws IOException
        {
                try {
                        ...
                        Logger.getLogger(MoveitWIRUploadHandler.class.getName()).log(Level.SEVERE, null, ex);
