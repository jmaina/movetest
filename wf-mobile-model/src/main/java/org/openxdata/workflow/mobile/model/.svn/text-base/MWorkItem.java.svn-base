...
public class MWorkItem extends AbstractRecord {
        ...
        private Boolean allowFormDataDelete;
        private String prefills;
        ...
        public void write(DataOutputStream dos) throws IOException {
                ...
                PersistentHelper.write(prefilledQns, dos);
                PersistentHelper.writeBoolean(dos, allowFormDataDelete);
        }
        ...
        public void read(DataInputStream dis) throws IOException, InstantiationException, IllegalAccessException {
                ...
                prefilledQns = PersistentHelper.read(dis, new MQuestionMap().getClass());
                allowFormDataDelete = PersistentHelper.readBoolean(dis);
        }
        ...
        public String getPrefilledString() {
                if(prefills != null) return prefills;
        ...
        public void setAllowFormDataDelete(boolean b) {
                allowFormDataDelete = new Boolean(b);
        }

        public boolean  isAllowFormDataDelete() {
                if(allowFormDataDelete == null) return true;
                return allowFormDataDelete.booleanValue();
        }
}
